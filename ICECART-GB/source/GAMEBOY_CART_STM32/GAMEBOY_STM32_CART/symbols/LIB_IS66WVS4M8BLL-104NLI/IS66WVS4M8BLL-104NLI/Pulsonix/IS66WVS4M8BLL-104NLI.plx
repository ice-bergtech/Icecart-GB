...
(library Library_1
	...
	(symbolDef "IS66WVS4M8BLL-104NLI" (originalName "IS66WVS4M8BLL-104NLI")
	...
	(compDef "IS66WVS4M8BLL-104NLI" (originalName "IS66WVS4M8BLL-104NLI") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "SIO2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "SIO3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "CLK") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SI/SIO0") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IS66WVS4M8BLL-104NLI"))
		...
		(attr "Mouser Part Number" "870-ISS4M8BLL-104NLI")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ISSI/IS66WVS4M8BLL-104NLI?qs=doiCPypUmgHfByEUFkOsAw%3D%3D")
		(attr "Manufacturer_Name" "Integrated Silicon Solution Inc.")
		(attr "Manufacturer_Part_Number" "IS66WVS4M8BLL-104NLI")
		(attr "Description" "PSRAM (Pseudo SRAM) Memory IC 32Mbit SPI, QPI 104 MHz 7 ns 8-SOIC")
		(attr "<Hyperlink>" "https://www.issi.com/WW/pdf/66-67WVS4M8ALL-BLL.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "IS66WVS4M8BLL-104NLI.stp")
